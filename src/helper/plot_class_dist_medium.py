...
ax.axis('equal')
plt.savefig(root_folder + "graphs/medium/class_dist/all_class_dist_medium_4_classes.png")
# plt.show()
...
ax.axis('equal')
plt.savefig(root_folder + "graphs/medium/class_dist/train_classes_medium_4_classes.png")
# plt.show()
...
ax.axis('equal')
plt.savefig(root_folder + "graphs/medium/class_dist/val_class_dist_medium_4_classes.png")
# plt.show()
...
ax.axis('equal')
plt.savefig(root_folder + "graphs/medium/class_dist/test_class_dist_medium_4_classes.png")
# plt.show()
